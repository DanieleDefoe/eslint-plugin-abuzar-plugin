...
export const ALLOWED_LAYER_IMPORTS_ERROR = "fsd-layer-import-error";
...
export default {
  meta: {
    ...
    messages: {
      [ALLOWED_LAYER_IMPORTS_ERROR]: "Only lower layers can be imported",
    },
  },
    ...
    return {
      ImportDeclaration(node) {
        ...
        if (!allowedLayerImports[currentFileLayer]?.includes(importLayer)) {
          context.report({
            node,
            messageId: ALLOWED_LAYER_IMPORTS_ERROR,
          });
        }
      },
    };
